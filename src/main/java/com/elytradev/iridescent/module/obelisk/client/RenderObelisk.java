...
public class RenderObelisk extends TileEntitySpecialRenderer<TileEntityObelisk> {
	...
	public void render(TileEntityObelisk te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		TextureAtlasSprite floorGlowmap = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("iridescent:blocks/obelisk_floor_glowmap");
		TextureAtlasSprite totemGlowmap = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("iridescent:blocks/totem_glowmap");
		TextureAtlasSprite totemTopGlowmap = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("iridescent:blocks/totem_top_glowmap");
