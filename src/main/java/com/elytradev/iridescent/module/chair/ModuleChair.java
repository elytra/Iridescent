...
public class ModuleChair extends Module {
	...
	public void onPreInit(FMLPreInitializationEvent e) {
		EntityRegistry.registerModEntity(new ResourceLocation("iridescent", "seat"), EntitySeat.class, "seat", Iridescent.nextEntityId++, Iridescent.inst, 64, 64, false);
		
		Iridescent.inst.network.register(TimeSkipPacket.class);
	...
	public void onRegisterBlocks(RegistryEvent.Register<Block> e) {
		e.getRegistry().register(CHAIR = new BlockChair(Material.CLOTH)
				.setHardness(0.8f)
				.setRegistryName("chair")
				.setUnlocalizedName("iridescent.chair")
				.setCreativeTab(CreativeTabs.DECORATIONS));
	}
	
	@SubscribeEvent
	public void onRegisterItems(RegistryEvent.Register<Item> e) {
		e.getRegistry().register(new ItemBlock(CHAIR).setRegistryName("chair"));
	}
	
	@SubscribeEvent
	public void onRegisterRecipes(RegistryEvent.Register<IRecipe> e) {
		e.getRegistry().register(new ShapedOreRecipe(null, CHAIR,
				"PW ",
				"PWW",
				"/ /",
				'P', "plankWood",
				'W', new ItemStack(Blocks.WOOL, 1, OreDictionary.WILDCARD_VALUE),
				'/', "stickWood").setRegistryName("chair"));
	}
