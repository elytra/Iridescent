package com.elytradev.iridescent.module.spiritgraves.client;
...
public class ModuleSpiritGravesClient extends ModuleClient {
	...
	private static final ResourceLocation VIGNETTE = new ResourceLocation("iridescent", "textures/misc/vignette.png");
	...
	public void onPostRenderOverlay(RenderGameOverlayEvent.Post e) {
		if (e.getType() == ElementType.ALL) {
			if (Minecraft.getMinecraft().objectMouseOver != null && Minecraft.getMinecraft().objectMouseOver.entityHit instanceof EntityGrave) {
				...
				String title = "\u00A7l"+I18n.format(entity.isOwner(Minecraft.getMinecraft().player) ? "iridescent.yourGrave" : "iridescent.othersGrave", entity.getOwner().getName());
				...
				if (entity.isOwner(Minecraft.getMinecraft().player)) {
					String line1 = I18n.format("iridescent.attackToEquip", GameSettings.getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindAttack.getKeyCode()));
					String line2 = I18n.format("iridescent.rightClickToEquip", GameSettings.getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindUseItem.getKeyCode()));
					...
					String line = I18n.format("iridescent.sneakRightClickToTakeOtherGrave", GameSettings.getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindSneak.getKeyCode()), GameSettings.getKeyDisplayString(Minecraft.getMinecraft().gameSettings.keyBindUseItem.getKeyCode()));
