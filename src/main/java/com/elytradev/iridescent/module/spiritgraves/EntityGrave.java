...
public class EntityGrave extends Entity {
	...
	private static final DataParameter<ItemStack> HOTBAR1 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR2 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR3 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR4 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR5 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR6 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR7 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR8 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> HOTBAR9 = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	
	private static final DataParameter<ItemStack> OFFHAND = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	
	private static final DataParameter<ItemStack> HELMET = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> CHESTPLATE = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> LEGGINGS = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	private static final DataParameter<ItemStack> BOOTS = EntityDataManager.createKey(EntityGrave.class, DataSerializers.ITEM_STACK);
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (source instanceof EntityDamageSource) {
			...
			if (eds.getTrueSource() instanceof EntityPlayer) {
				if (isOwner((EntityPlayer)eds.getTrueSource())) {
					giveItems((EntityPlayer)eds.getTrueSource(), true);
					playSound(ModuleSpiritGraves.DISPEL, 1, 1);
					new GraveDispelMessage(eds.getTrueSource(), this).sendToAllWatching(this);
					setDead();
				}
			}
		}
	...
	public void onUpdate() {
		super.onUpdate();
		if (Iridescent.isModuleLoaded(ModuleSpiritGravesClient.class)) {
			Iridescent.getModule(ModuleSpiritGravesClient.class).onUpdate(this);
		}
		if (posY < 5) {
			...
			if (!ep.isDead
				...
				if (dot > 1 - 0.025 / len) {
					if (dist > 3.7 || dist < 3.3) {
						...
						double targetX = diff.x*speed;
						double targetY = diff.y*speed;
						double targetZ = diff.z*speed;
