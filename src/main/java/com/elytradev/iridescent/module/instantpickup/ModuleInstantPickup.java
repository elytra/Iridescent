package com.elytradev.iridescent.module.instantpickup;
...
public class ModuleInstantPickup extends Module {
	...
	private final Accessor<Integer> delayBeforeCanPickup = Accessors.findField(EntityItem.class, "field_145804_b", "pickupDelay");
